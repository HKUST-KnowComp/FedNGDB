...
num_clients = 10
max_processes = 20
num_processes = int(max_processes // num_clients * num_clients)
...
def sample_all_data(id):
    ...
    # The process sample clients id.
    id_clients = id % num_clients

    for data_dir in n_queries_train_dict.keys():
    # for data_dir in ['FB15k-237-betae']:

        print("Load Train Graph " + data_dir)
        train_path = "../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/train_" + str(id_clients) + ".txt"
        ...
        valid_path = ["../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/train_" + str(id_clients) + ".txt",
                      "../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/valid_" + str(id_clients) + ".txt"]
        ...
        test_path = ["../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/train_" + str(id_clients) + ".txt",
                     "../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/valid_" + str(id_clients) + ".txt",
                     "../KG_data_fed/" + data_dir + "/fed-"+ str(num_clients) + "/test_" + str(id_clients) + ".txt"]
        ...
        def sample_valid_graph_with_pattern(pattern):
            ...
            return sampled_valid_query, valid_query_train_answers, valid_query_valid_answers, num_sample
        ...
        def sample_test_graph_with_pattern(pattern):
            ...
            while True:
                ...
                if len(test_query_train_answers) > 0 and len(test_query_valid_answers) > 0 \
                    ...
                    if num_sample > 100:
                        break
            return sampled_test_query, test_query_train_answers, test_query_valid_answers, test_query_test_answers, num_sample
        ...
        with open("../sampled_data_fed/" + data_dir + "/fed-" + str(num_clients) + "/" + data_dir + "_train_queries_" + str(id_clients) + "_" + str(id) + ".json", "w") as file_handle:
        ...
        for query_type, sample_pattern in first_round_query_types.items():
            ...
            n_query = n_query // num_processes
            for _ in tqdm(range(n_query)):
                sampled_valid_query, valid_query_train_answers, valid_query_valid_answers, num_sample = \
        ...
        with open("../sampled_data_fed/" + data_dir + "/fed-" + str(num_clients) + "/" +
                  data_dir + "_valid_queries_" + str(id_clients) + "_" + str(id) + ".json", "w") as file_handle:
        ...
        for query_type, sample_pattern in first_round_query_types.items():
            ...
            n_query = n_query // num_processes
            for _ in tqdm(range(n_query)):
                sampled_test_query, test_query_train_answers, test_query_valid_answers, test_query_test_answers, num_sample = \
        ...
        with open("../sampled_data_fed/" + data_dir + "/fed-" + str(num_clients) + "/" + data_dir + "_test_queries_" + str(id_clients) + "_" + str(id) + ".json", "w") as file_handle:
