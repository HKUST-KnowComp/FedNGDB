...
class GeneralModel(nn.Module):
    ...
    def evaluate_generalization(self, query_encoding, entailed_answers, generalized_answers,
                                client_evaluate=False, entity_mask=None, all_scoring=None):
        """
        ...
        for i in range(len(entailed_answers)):
            ...
            if client_evaluate:
                masks = [pos for pos, num  in enumerate(entity_mask) if num == 0]
                all_answers = list(set(all_answers) | set(masks))
